...
<div
	class="fixed top-24 mx-auto grid min-w-[80vw] max-w-[100vw] place-items-center rounded-md bg-[#efc7c7a2] py-2 pl-4 pr-4 text-center transition-all duration-300 ease-in-out"
>
