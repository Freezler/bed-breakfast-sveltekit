...
<div
	class=" fixed bottom-[50px] mx-auto grid min-w-[80vw] max-w-[100vw] place-items-center rounded-md bg-[#efc7c7a2] py-2 pl-4 pr-4 text-center"
>
	<h1 class="mb-2 text-pretty text-xl font-semibold leading-6">
