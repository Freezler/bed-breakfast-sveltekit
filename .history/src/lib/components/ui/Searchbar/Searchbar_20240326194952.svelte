...
<nav
	class="top-0 z-10 mt-0 flex h-[60px] w-[100vw] flex-row items-center justify-between bg-transparent px-2 md:px-4"
>
	<div class=" flex h-full max-w-full flex-row items-center justify-start">
		<div class="z-10 justify-end rounded-md bg-gray-950 p-[8.2px] py-[12px]  md:flex">
			<svg
