...
>
	<div class=" flex h-full max-w-full flex-row items-center justify-start">
		<div class="z-10 justify-end rounded-lg md:rounded-xl bg-gray-950 p-[8.5px] md:p-[12.5px] py-[12px] md:py-[16px] md:flex">
			<svg
		...
		<div class="-translate-x-2 justify-end rounded-e-lg bg-slate-100 p-[7px] md:flex">
			<svg
				xmlns="http://www.w3.org/2000/svg"
				width="1.3em"
				height="1.35em"
