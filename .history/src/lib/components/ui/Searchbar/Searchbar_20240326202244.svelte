...
>
	<div class=" flex h-full max-w-full flex-row items-center justify-start">
		<div class="z-10 justify-end rounded-md bg-gray-950 p-[8.5px] py-[12px]  md:flex">
			<svg
		...
		<div class="-translate-x-2 justify-end rounded-e-md bg-slate-200 p-[12.25px] md:flex">
			<svg
				xmlns="http://www.w3.org/2000/svg"
				width="1em"
				height="1em"
