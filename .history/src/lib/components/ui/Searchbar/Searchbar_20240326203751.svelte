...
<nav
	class="top-0 z-10 mt-0 flex h-[78px] w-[100vw] flex-row items-center justify-between bg-transparent px-4 md:px-4"
>
	<div class=" flex h-full max-w-full flex-row items-center justify-start">
		...
		<div class="-translate-x-2 justify-end rounded-e-lg bg-slate-100 p-[7px] md:p-[12.5px] md:flex">
			<svg
				xmlns="http://www.w3.org/2000/svg"
				width="1.3em"
				height="1.35em"
