...
>
	<div id="">
		<span
			class="absolute left-1/2 top-[3%] h-[2px] w-[24px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gray-500 transition-all duration-300 group-active:w-[26px] group-active:translate-y-[6px] group-active:rotate-45"
		></span>
		<span
