...
>
	<div id="">
		...
		></span>
		<span
			class="absolute left-1/2 top-[50%] h-[2px] w-[24px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gray-500 transition-all duration-700 group-active:opacity-0 group-active:-translate-y-[5px]"
		></span>
		<span
