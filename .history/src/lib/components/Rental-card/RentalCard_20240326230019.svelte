...
<div
	class="mt-[12px] grid h-[418px] place-self-center rounded-b-2xl rounded-t-2xl border-[1px] border-gray-400 shadow-lg md:grid-rows-[1fr] max-w-[400px] w-[95vw] md:w-[400px] md:max-w-full"
>
	<img
