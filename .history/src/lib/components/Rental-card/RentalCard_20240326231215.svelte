...
<div
	class="mt-[12px] grid h-[418px] place-self-center rounded-b-2xl w-full rounded-t-2xl border-[1px] border-gray-400 shadow-lg md:grid-rows-[1fr_1fr_1fr_1fr] max-w-[98vw]  md:w-[600px] md:max-w-full items-center"
>
	<img
