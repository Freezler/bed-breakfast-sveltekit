...
<div
	class="mt-[12px] grid h-[418px] place-self-center rounded-b-2xl rounded-t-2xl border-[1px] border-gray-400 shadow-lg md:grid-rows-[1fr_1fr_1fr_1fr] max-w-[400px] w-[95vw] md:w-[600px] md:max-w-[100%] md:grid-cols-1 md:grid-rows-3 md:h-[400px] md:rounded-2xl"
>
	<img
	...
	/>
	<div class="grid-rows-sub grid  grid-cols-1  pl-4 w-full h-9 ">
